...
function checkPrice(){
	var p = document.getElementById("userOldPass");
	if(!isNaN(p)){}
	else{}
					...
					<div class="row" style="padding-top: 0px">
						...
						<div
							...
							<div style="text-align: center;" id="localImag">
								<img src="img/faces/${DISHES_INFO.dishesImg}" id="face" name="dishesImg"
					...
					<div class="panel panel-danger" style="margin-top: 10px">
						...
						<div class="panel-body">
							...
							<div style="text-align: center;">
								<img src="img/faces/${DISHES_INFO.dishesImg}" id="face" width="200px"
