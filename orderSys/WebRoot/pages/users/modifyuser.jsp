<%@ page language="java" import="java.util.*,com.chinasofti.util.sec.Passport" pageEncoding="UTF-8"%>
			...
			<div style="width: 50%;display: inline-block;">
				<div>
					...
					<form class="form-horizontal" role="form" style="margin-top: 20px"
						method="post" action="modifyuserpass.order">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="firstname"
									...
									<input type="hidden" name="roleId" value="${USER_INFO.role}">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="password" class="form-control" id="userOldPass"
									name="userOldPass" placeholder="请输入员工的密码"
									onblur="checkoldpass()" >
							</div>
						...
						<form class="form-inline" role="form"
							...
							<div class="form-group">
								<label class="sr-only" for="inputfile">文件输入</label> <input
									type="file" id="inputfile" name="faceimg" onchange="viewImg(this)">
							</div>

							<input type="button" class="btn btn-danger" value="员工不可以更改自己的头像" disabled="disabled"
								onclick="begin()" /><!-- 更新头像图片 -->
						</form>
					</div>
