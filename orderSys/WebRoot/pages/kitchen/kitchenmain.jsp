...
<script type="text/javascript">
	...
	function state(obj) {
		...
		if (obj.innerHTML != "正在烹饪") {
			obj.innerHTML = "正在烹饪";
			obj.style.background = "#D9534F";
			obj.style.border = "#D9534F";
		} else {
			obj.parentNode.parentNode.style.display = "none";
			obj.style.backgroundColor = "blue";
			send(obj);
			//		window.location.href="/OrderSys/changestate.order?orderId="+obj.value;

		}
	}
	function send(obj) {
		//alert("send");
		var url = "/OrderSys/sendbord_dishes.order?bord1=" + obj.value
				+ "&time=" + Math.random();
		txtAjaxRequest(url, "get", true, null, sendSuccess, null, null);
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li><a href="tokitchenmain.order?page=1"><i
							class="glyphicon glyphicon-cutlery"></i>&nbsp; 备菜界面 <span
...
<!-- 
									<div style="text-align: right;">
										<a href="toadddishes.order" class="btn btn-success"
 ...
 -->
									<div class="panel-body">
										...
										<div class="table-responsive">
												...
												<tbody>
													...
													<c:choose>
														...
														<tr>
															...
															<td>
															<button class="btn btn-success" onclick="state(this)" value="table+${temp.tableId }+dish+${temp.dishesId}+is+ready" style="width: 120px; margin-top: -5px; margin-right: 10px;">添加菜品</a>
															</button>
											...
											<nav>
											<ul class="pager">
												<li><a href="tokitchenmain.order?page=1" id="firstpage">&larr;首页</a></li>
												<li><a href="tokitchenmain.order?page=${page-1} "
													id="pre">上一页</a></li>
												<li><a href="tokitchenmain.order?page=${page+1} "
													id="next">下一页</a></li>
												<li><a href="tokitchenmain.order?page=-1" id="last">末页&rarr;</a></li>
											</ul>
											</nav>
